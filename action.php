...
if (isset($_POST['signup'])) {
	...
	if (mysqli_num_rows($run)>0) {
		...
		$sql="INSERT INTO `user_info` (`uid`, `name`, `uname`, `age`, `pno`, `psw`, `email`)
		 VALUES (NULL, '$name', '$uname', '$age', '$pno', '$psw', '$email')";
		$run=mysqli_query($con,$sql);
		if($run){
