...
<body id="body">
  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container clearfix">
      <div class="contact-info float-left">
        <i class="fa fa-envelope-o"></i> <a href="mailto:harsha.62004@gmail.com">hrstravels@gmail.com</a>
        <i class="fa fa-phone"></i> +91 9986295866
      </div>
    </div>
  </section>
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#body" class="scrollto">HRS<span>Travels</span></a></h1>
  ...
  <main id="main">
      ...
      <div class="container-fluid">
        <div class="row no-gutters">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="portfolio-item wow fadeInUp">
            <a href="img/port2.jpeg" class="portfolio-popup">
                <img src="img/port2.jpeg" alt="" style="height:350px;">
                <div class="portfolio-overlay">
                  <div class="portfolio-info"><h2 class="wow fadeInUp"></h2></div>
                </div>
              </a>
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>HRSTravels</strong>. All Rights Reserved
      </div>
      <div class="credits">
        
        Designed by <a href="#">Infinite Network Solutions</a>
      </div>
    </div>
  </footer><!-- #footer -->
